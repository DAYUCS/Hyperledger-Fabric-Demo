/*
 *  Copyright 2016, 2017 Chinasystems - All Rights Reserved.
 *
...
public class TradeFinanceIT {
    ...
    public void setup() {
        ...
        try {
            ...
            runChain(client, fooChain, true, sampleOrg);
            fooChain.shutdown(true); // Force foo chain to shutdown clean up resources.
            out("\n");

            sampleOrg = testConfig.getIntegrationTestsSampleOrg("peerOrg2");
            runChain(client, constructChain(BAR_CHAIN_NAME, client, sampleOrg), true, sampleOrg); //run a newly constructed bar chain with different b value!
    ...
    void runChain(HFClient client, Chain chain, boolean installChainCode, SampleOrg sampleOrg) {
        ...
        try {
            ...
            if (installChainCode) {
                ...
                installProposalRequest.setChaincodeSourceLocation(new File(TEST_FIXTURES_PATH + "/sdkintegration/gocc/sample2"));
            ...
            */
            ...
            out("Sending instantiateProposalRequest to all peers without arguments");
            successful.clear();
            failed.clear();
            ...
            out("Sending instantiateTransaction to orderer without arguments");
            chain.sendTransaction(successful, orderers).thenApply(transactionEvent -> {
                ...
                try {
                    ...
                    transactionProposalRequest.setArgs(new String[] {"inspect", "IMLC-000001", "Chinasystems", "China Ocean Shipping Company"});
                    ...
                    out("sending transactionProposal to all peers with arguments: inspect(IMLC-000001,Chinasystem,China Ocean Shipping Company)");
                    ...
                    if (failed.size() > 0) {
                        ...
                        fail("Not enough endorsers for inspect(IMLC-000001,Chinasystem,China Ocean Shipping Company):" + failed.size() + " endorser error: " +
                    ...
                    out("Sending chain code transaction(inspect(IMLC-000001,Chinasystem,China Ocean Shipping Company)) to orderer.");
                ...
                try {
                    ...
                    //
                    String expect = "{\"reference\":\"IMLC-000001\",\"exporter\":\"Chinasystems\",\"shippingCorporation\":\"China Ocean Shipping Company\",\"negotiationBank\":\"\",\"importBank\":\"\",\"status\":\"Inspection\"}"; // should be different by step!!!
                    out("Now query chain code for the value of IMLC-000001.");
                    QueryByChaincodeRequest queryByChaincodeRequest = client.newQueryProposalRequest();
                    queryByChaincodeRequest.setArgs(new String[] {"query", "IMLC-000001"});
                    ...
                    for (ProposalResponse proposalResponse : queryProposals) {
                        if (!proposalResponse.isVerified() || proposalResponse.getStatus() != ProposalResponse.Status.SUCCESS) {
                            ...
                            out("Query payload of IMLC-0001 from peer %s returned %s", proposalResponse.getPeer().getName(), payload);
